        ...
        >
            ...
            >
                <section>
                    ...
                    <h2
                        id="main-heading"
                        class="text-5xl font-bold tracking-tight text-gray-900 dark:text-slate-500 sm:text-6xl"
                    >
            ...
            <section class="w-full md:w-1/2">
                <div class="relative group">
                    <div
                        class="absolute md:-inset-1 md:bg-gradient-to-r from-primary to-indigo-500 rounded-md blur-xl opacity-75 group-hover:opacity-100 transition duration-200"
                    />
                    <div
                    ...
                    <div class="relative">
                        <img
                            ...
                            alt="Profile"
                            class="w-64 h-110 rounded-md m-auto object-cover border-4 border-white/50 shadow-xl"
                        />
                    </div>
                </div>
            </section>
